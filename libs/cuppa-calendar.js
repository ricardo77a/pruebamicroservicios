(function(window){
  'use strict';
	...
	var cal_days_labels = ['Do', 'Lu', 'Ma', 'Mi', 'Ju', 'Vi', 'Sa'];
	var cal_full_days_lables = ["Domingo","Lunes","Martes","Miércoles","Jueves","Viernes","Sábado"];

	// these are human-readable month name labels, in order
	var cal_months_labels = ['Enero', 'Febrero', 'Marzo', 'Abril',
	                     'Mayo', 'Junio', 'Julio', 'Agosto', 'Septiembre',
	                     'Octubre', 'Noviembre', 'Diciembre'];
	var cal_months_labels_short = ['Ene', 'Feb', 'Mar', 'Abr',
		                     'May', 'Jun', 'Jul', 'Ago', 'Sep',
		                     'Oct', 'Nov', 'Dic'];
